...
data_dir="/home/r9000k/v2_project/data/RTK_TEST1/"
colmap_res_txt="${data_dir}/images.txt"   # 图像colmap重建位姿结果
video_gps_txt="${data_dir}/gps.txt" # 图像GNSS数据txt (时间戳 经纬高 空格分开)
gps_ned_ori="${data_dir}/GNSS_config.yaml" #图像gnss参考点输入文件
colmap2gnss_SRt_xml="${data_dir}/srt_colmap2gnss.yaml" #计算的srt关系保存路径
